...
describe('Datacenter', () => {
  ...
  describe('getFetchedOnlineRigs', () => [
    describe('should return', () => {
      it('no rigs on null', () => {
        datacenter
          .getFetchedOnlineRigs(_.times(10, _.constant(null)))
          .should.have.lengthOf(0);
      });
      it('rigs when not null', () => {
        datacenter
          .getFetchedOnlineRigs(onlineRigsSample)
  ...
  describe('getFetchedOfflineRigs', () => {
    describe('should return', () => {
      ...
      it('rigs that are offline', () => {
        datacenter
          .getFetchedOfflineRigs(statsSample.rigs.seen, [])
  ...
  describe('getRigsThatBecameOnline', () => {
    describe('should return', () => {
      it("new online rigs that haven't been seen before", () => {
        datacenter
          .getRigsThatBecameOnline(newOnlineRigsSample, statsSample.rigs.seen)
  ...
  describe('getRigsThatAreFixed', () => {
    describe('should return', () => {
      it('rigs that become online again', () => {
        datacenter
          .getRigsThatAreFixed(statsSample.rigs.currently.offline, [])
    ...
    describe('should call', () => {
      describe('request stub', () => {
        it('with correct arguements', async () => {
          ...
          stats.rigs.currently.online.should.have.lengthOf(
            configDiscovery.number_of_rigs
          );
          ...
          for (let i = 0; i < configDiscovery.number_of_rigs; i++) {
            ...
            const uri = `http://${hostname.prefix + rigId}:${api.port}${
              api.endpoint
            }`;
